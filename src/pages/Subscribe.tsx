        ...
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto md:justify-center md:max-w-[907px] md:flex-col">
                <div className="max-w-[640px] md:flex md:items-center md:flex-col md:text-center md:mb-8">
                    ...
                    <div className="mt-4 flex leading-relaxed gap-6 md:max-w-[370px]">
                        <div className="flex gap-3 md:gap-4">
                            ...
                            <p className="max-w-[90px] text-white leading-relaxed">
                                De 20 a 26 de Junho
                            </p>
                        </div>
                        ...
                        <div className="flex gap-3 md:gap-1">
                            ...
                            <p className="max-w-[150px] text-white leading-relaxed">
                                Evento inédito, online e gratuito
                            </p>
                        </div>
                    </div>

                    <div className="mt-10 text-gray-200 leading-relaxed md:max-w-[370px] md:hidden">
                        <p>Evento ministrado por:</p>
                        <div>
                            <div className="flex items-center gap-4 mt-4 md:justify-center md:w-full">
                                ...
                                <div className="leading-relaxed">
                                    <strong className="font-bold text-2xl block">Pedro Cantanhêde</strong>
                                    <span className="text-gray-200 text-sm block">Full-Stack developer focused on the best technologies</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="py-8 px-6 bg-gray-700 border border-gray-500 rounded z-10 md:max-w-lg">
            ...
            <img src={mockup} className="mt-10" alt="Tela do Visual Studio Code com o projeto Ignite Lab. Logo do React. Menu com ícones de check, vídeo, mobile, desktop e challenger." />
